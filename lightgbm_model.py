...
# Removed Ridge and added LightGBM
...
TEST_FRACTION = 0.20
# RIDGE_ALPHA = 1.0 # Removed as not needed for LightGBM
RANDOM_SEED = 42
...
print("=" * 80)
print("LIGHTGBM MODEL: LightGBM for 30-minute Workflow Demand")
print("=" * 80)
print("\nSTEP 1: Loading Data")
print("-" * 80)
...
# Changed model from Ridge to LGBMRegressor
...
ax.plot(test["half_hour_ts"], y_test_pred, label="Predicted (LightGBM)", linewidth=2, linestyle="--", alpha=0.8)
...
plt.tight_layout()
plt.savefig("lightgbm_timeseries_30min.png", dpi=150, bbox_inches="tight")
plt.close()
print("✓ Saved: lightgbm_timeseries_30min.png")
...
plt.tight_layout()
plt.savefig("lightgbm_scatter_30min.png", dpi=150, bbox_inches="tight")
plt.close()
print("✓ Saved: lightgbm_scatter_30min.png")
...
plt.tight_layout()
plt.savefig("lightgbm_residuals_30min.png", dpi=150, bbox_inches="tight")
plt.close()
print("✓ Saved: lightgbm_residuals_30min.png")
